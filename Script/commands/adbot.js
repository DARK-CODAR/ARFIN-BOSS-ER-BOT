...
module.exports.run = async({ api, event, args }) => {
    ...
    if (args[0] == "box") {
        ...
        let callback = () => api.sendMessage({ body: msg, attachment: fs.createReadStream(__dirname + "/cache/1.png") },
            event.threadID,
    ...
    if (args[0] == "admin") {
        let callback = () => api.sendMessage({
                body: `———»ADMIN BOT«———\n❯ Name: 𝐀𝐑𝐅𝐈𝐍 𝐈𝐒𝐋𝐀𝐌 𝐀𝐅𝐈\n❯ Facebook: https://www.facebook.com/Arfinafi69\n❯ Thanks for using ${global.config.BOTNAME} bot`,
        ...
        return request(encodeURI(`https://graph.facebook.com/61566562741771/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`))
