...
module.exports.run = async function({ api, event, args }) {
    ...
    for (let z in threadInfo.userInfo) {
        ...
        if (gioitinhone == "MALE") { gendernam.push(z + gioitinhone) } else if (gioitinhone == "FEMALE") { gendernu.push(gioitinhone) } else { nope.push(nName) }
    };
