module.exports.config = {
    ...
    'version': "1.0.3",
    'hasPermssion': 0x2,
    'credits': "𝐀𝐑𝐅𝐈𝐍 𝐁𝐎𝐒𝐒 𝐄𝐑 𝐁𝐎𝐓 ☠︎︎ 𝐈",
                ...
                case '3':
                    {
                        ...
                        var _0x28f0df = [];
                        for (const _0xbc8b38 of _0x5d5540)
                            if (parseInt(_0xbc8b38)) {
        ...
        case "sendnoti":
            {
                ...
                var _0x65d4d4 = 1;
                var _0x49a57d = [];
                for (const _0x20f8ed of _0x3ad798)
                    if (!(isNaN(parseInt(_0x20f8ed)) || _0x20f8ed == _0x4db658.threadID)) {
