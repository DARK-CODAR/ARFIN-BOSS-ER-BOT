...
async function makeImage({ one: senderID, two: mentionedID }) {
    ...
    let senderAvatar = (await axios.get(
        `https://graph.facebook.com/${senderID}/picture?width=512&height=512&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`, { 'responseType': "arraybuffer" }
    )).data;
    ...
    let mentionedAvatar = (await axios.get(
        `https://graph.facebook.com/${mentionedID}/picture?width=512&height=512&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`, { 'responseType': "arraybuffer" }
    )).data;
